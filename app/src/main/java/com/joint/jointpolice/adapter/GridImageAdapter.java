...
public class GridImageAdapter extends
    ...
    private int showAddViewType = 1;
    private int showDelViewType = 1;
    ...
    public void setShowAddViewType(int showAddViewType) {
        this.showAddViewType = showAddViewType;
    }

    public void setShowDelViewType(int showDelViewType) {
        this.showDelViewType = showDelViewType;
    }

    public void setPreView(int showAddViewType, int showDelViewType) {
        setShowAddViewType(showAddViewType);
        setShowDelViewType(showDelViewType);
    }
    ...
    public int getItemCount() {
        if (list.size() < selectMax && showAddViewType == 1) {
            return list.size() + 1;
        } else {
            return list.size();
        }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
        View view = mInflater.inflate(R.layout.item_locale_image,
                viewGroup, false);
    ...
    private boolean isShowAddItem(int position) {
        ...
        return showAddViewType == 1 && position == size;
    }
            ...
            viewHolder.ll_del.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    ...
                    if (mOnItemDelClickListener != null) {
                        mOnItemDelClickListener.onItemDelClick(index);
                    }
